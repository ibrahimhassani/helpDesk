...
<body data-page="tabs_accordion">
    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            ...
            <div class="container">
                <h2>Demandes de Videoconference</h2>
                <div class="panel">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>Origine</th>
                                    <?php
                                    $resp = $db->query("SELECT * FROM site");
                                    while ($row = $resp->fetch()) {
                                        ?>
                                        <th><?php echo $row['nom_s']; ?></th>
                                    <?php } ?>
                                    <th></th>
                            ...
                            <tbody><?php
                                ...
                                $res = $db->query("SELECT id_d,de FROM demande WHERE user_d='$user'");
                                while ($row = $res->fetch()) {
                                    $demande = $row['id_d'];
                                    ...
                                    <tr>
                                        ...
                                        while ($row1 = $res1->fetch()) {
                                            $res2 = $db->query("SELECT site FROM site_demande WHERE demande='$demande'");
                                            $found = false;
                                            while ($row2 = $res2->fetch()) {
                                                if (strcmp($row2['site'], $row1['id_s']) == 0) {
                                                    $found = true;
                                                };
                                            }
                                            ?>
                                        ...
                                        ?>
                                            <td style="width: 50px"><a class="btn btn-danger" href="delete_demande.php?id=<?php echo $demande; ?>">
