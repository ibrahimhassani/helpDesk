                    ...
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tbody><?php
                                ...
                                $res = $db->query("SELECT * FROM anomalie WHERE type=1");
                                while ($row = $res->fetch()) {
                                    ?>
                                    <tr>
                                        <td><?php echo strcmp($row['composant'], "") == 0 ? "non specifié" : $row['composant']; ?></td>
                                        ...
                                        <td><?php
                                            ...
                                            ?> </td>
                                        <td><a class="btn btn-danger" href="delete_anomalie_h.php?id=<?php echo $row['id_a_h']; ?>">
